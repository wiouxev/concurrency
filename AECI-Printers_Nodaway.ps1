...
$printers += [pscustomobject]@{PrinterName="P-ND-60-3002";PrintServer="\\HQ-PRTSRV01-PRD\P-ND-60-3002";ADGroup="";Default="1"}
$printers += [pscustomobject]@{PrinterName="NOD-TAG-1";PrintServer="\\HQ-PRTSRV01-PRD\NOD-TAG-1";ADGroup="";Default="1"}
