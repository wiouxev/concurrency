...
Add-Printer -ConnectionName \\hq-prtsrv03-prd\THOFFICECOLOR
Add-Printer -ConnectionName \\HQ-PRTSRV03-PRD\P-TH-607-TAGLIST
Add-Printer -ConnectionName \\hq-prtsrv03-prd\THELECTMFD
Add-Printer -ConnectionName \\HQ-PRTSRV03-PRD\THTRAINING
