...
$printers += [pscustomobject]@{PrinterName="Essex MFD 1 - TOSHIBA Universal Printer 2";PrintServer="\\HQ-PRTSRV01-PRD\Essex MFD 1 - TOSHIBA Universal Printer 2";ADGroup="";Default="1"}
$printers += [pscustomobject]@{PrinterName="P-EX-60-tag2";PrintServer="\\HQ-PRTSRV01-PRD\P-EX-60-tag2";ADGroup="";Default="1"}
