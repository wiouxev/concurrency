...
Version history:
1.0.1 - (2022-06-06) Added to check for certificate with subject names matching CN=WIN in addition to CN=DESKTOP and CN=LAPTOP
#>
Process {
# Functions
