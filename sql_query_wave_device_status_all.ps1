...
$devicesquery = "select d.batchid, b.batchname, d.commonname, description, AgentLastContactTimestamp, DiscoveryStatus, CredentialCacheStatus, reaclstatus, offlinedomainjoinstatus, Cutoverstatus from $devicetable D left join ADM_Batch B on D.BatchID=B.BatchID"
