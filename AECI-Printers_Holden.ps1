...
$printers += [pscustomobject]@{PrinterName="P-HN-60-4505";PrintServer="\\HQ-PRTSRV01-PRD\P-HN-60-4505";ADGroup="";Default="1"}
$printers += [pscustomobject]@{PrinterName="P-HN-60-tag1";PrintServer="\\HQ-PRTSRV01-PRD\P-HN-60-tag1";ADGroup="";Default="1"}
