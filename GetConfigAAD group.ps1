# claims training - devices group = 4c79b6e0-9c27-464d-94e3-48756f83a54e
...
#$groupName = read-host -prompt 'AAD group name'

 
#$Groups = Get-AADGroup | Get-MSGraphAllPages
$Group = Get-AADGroup -Filter "displayname eq 'Claims Training - Devices'"
